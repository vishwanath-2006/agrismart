...
export const INITIAL_PRODUCE: ProduceListing[] = [
  {
    ...
    category: 'Vegetables',
    imageUrl: TOMATO_IMG,
    imageUrls: [TOMATO_IMG, TOMATO_IMG, TOMATO_IMG],
  ...
  },
  {
    ...
    category: 'Vegetables',
    imageUrl: ONION_IMG,
    imageUrls: [ONION_IMG, ONION_IMG, ONION_IMG],
    qualityGrade: 'Grade A',
    quantityKg: 1200,
  ...
  },
  {
    ...
    category: 'Vegetables',
    imageUrl: POTATO_IMG,
    imageUrls: [POTATO_IMG, POTATO_IMG, POTATO_IMG],
  ...
  },
  {
    ...
    category: 'Grains',
    imageUrl: WHEAT_IMG,
    imageUrls: [WHEAT_IMG, WHEAT_IMG, WHEAT_IMG],
  ...
  },
  {
    ...
    category: 'Fruits',
    imageUrl: APPLE_IMG,
    imageUrls: [APPLE_IMG, APPLE_IMG, APPLE_IMG],
    qualityGrade: 'Premium',
    quantityKg: 650,
    minOrderQuantityKg: 100,
    pricePerKg: 110,
